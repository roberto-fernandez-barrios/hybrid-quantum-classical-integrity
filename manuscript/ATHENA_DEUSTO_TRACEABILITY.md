...
| 3.1.4 — integridad y confidencialidad de datos | Regiones ciegas exactas del camino de etiquetas; Proposición 3 (materialidad ⇒ separabilidad agregada); Corolario 3 (referencia agregada confiable para integridad de conclusión, item-alineada para identidad); Proposición 6 (sin raíz no controlada no hay autenticación local) | E1, E2, E3, E4, E12 | Parcial alto en integridad | Confidencialidad, leakage y side channels no se evalúan |
