...
**Table 0. Clean ID performance by model and projected dimension.** Clean performance establishes the operating point from which perturbation impact is measured. Values are computed from the clean rows of the aggregated paper-core results.
