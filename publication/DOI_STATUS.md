...
Status: **version 1.3.3 prepared** (bibliographic/editorial correction only;
...
|---|---|---|---|
| 1.3.3 | recorded here by the release pipeline | `paper15-q1-v1.3.3` / recorded after release | bibliographic/editorial correction only; no experiment, kernel, draw, model, seed, intervention, policy decision or scientific evidence rerun or changed |
