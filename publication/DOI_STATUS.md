...
Status: **version 1.3.1 DOI reserved (10.5281/zenodo.22651111); publication in progress** (formal and editorial correction of Paper 1.5; experimental evidence frozen at 1.3.0);
the version DOI of 1.3.1 is minted by the release pipeline
...
Versions 1.1.0, 1.1.1, 1.2.0 and 1.3.0 and their records are immutable: 1.3.1
is a new Zenodo version under the same concept DOI, never an in-place edit.
...
Release order for 1.3.1 (so that PDF, `CITATION.cff`, `.zenodo.json`, tag,
GitHub release and Zenodo record point at the same object):

1. formal review of the corrected statements and hostile editorial check pass
   with no objective error remaining;
2. correction commit; tests; verifier; clean rebuild; page-by-page
...
5. release commit, annotated tag `paper15-q1-v1.3.1`, GitHub release with the
