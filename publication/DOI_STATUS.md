...
Status: **version 1.3.2 DOI reserved (10.5281/zenodo.22664417); publication in progress** (controlled methodological/editorial
correction; experimental evidence frozen at 1.3.0). The version DOI of 1.3.2
is minted by the release pipeline
...
|---|---|---|---|
| 1.3.2 | `10.5281/zenodo.22664417` | `paper15-q1-v1.3.2` / pending | controlled taxonomy correction; frozen-only derived audit tables; no experimental rerun |
...
Versions 1.1.0, 1.1.1, 1.2.0, 1.3.0 and 1.3.1 and their records are
immutable: 1.3.2 is a new Zenodo version under the same concept DOI, never an
in-place edit.
