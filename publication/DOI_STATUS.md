...
Status: **version 1.3.2 published (10.5281/zenodo.22664417; 2026-09-08)** (controlled methodological/editorial
correction; experimental evidence frozen at 1.3.0). The version DOI of 1.3.2
was minted and published by the release pipeline
...
Release order for 1.3.2 (so that PDF, `CITATION.cff`, `.zenodo.json`, tag,
...
5. release commit, annotated tag `paper15-q1-v1.3.2`, GitHub release with the
