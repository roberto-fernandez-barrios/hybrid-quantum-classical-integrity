...
Status on 7 September 2026: **version 1.2.0 prepared**; concept DOI
`10.5281/zenodo.22550852` (resolves to the latest archived version). The
version DOI of 1.2.0 is minted by the release pipeline
...
no token is stored in the repository and no earlier token is reused. Until
that step runs, every document cites the concept DOI for 1.2.0 and the table
below records the immutable earlier versions.

| Version | Version DOI | Tag / release commit | Deposited files |
|---|---|---|---|
| 1.2.0 | recorded here by the release pipeline | `paper15-q1-v1.2.0` | `paper15-q1-v1.2.0.zip` (compact review artifact), `paper15-q1-v1.2.0-source.zip`, `SHA256SUMS.txt` |
