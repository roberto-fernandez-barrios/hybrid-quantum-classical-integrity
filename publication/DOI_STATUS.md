...
| Concept DOI (all versions) | `10.5281/zenodo.22550852` |
| Zenodo record | <https://zenodo.org/records/22550853> |
| Artifact version | `1.1.0` (frozen 1.0.0 evidence plus the preregistered reinforcement gates) |
| Repository tag | `paper15-q1-v1.1.0` (release commit `10a2a52`) |
...
6. release commit `10a2a52`, immutable tag, GitHub release with the artifact ZIP;
7. artifact and source ZIPs uploaded to the reserved deposition and published
   (record state `done`, 2026-09-06 19:30 UTC).
...
be a new Zenodo version under the concept DOI, never an in-place edit. DOI
resolution through doi.org can lag the Zenodo record by minutes after
publication.
