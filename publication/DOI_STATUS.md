...
Status: **version 1.3.0 DOI reserved (10.5281/zenodo.22648573); publication in progress** (final scientific closure of Paper 1.5);
...
|---|---|---|---|
| 1.3.0 | `10.5281/zenodo.22648573` | `paper15-q1-v1.3.0` | `paper15-q1-v1.3.0.zip` (compact review artifact), `paper15-q1-v1.3.0-source.zip` (tagged source snapshot), `SHA256SUMS.txt`; sizes and hashes recorded after publication |
