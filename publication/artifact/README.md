# Paper 1.5 compact review artifact — version 1.3.1
...
regenerated by the unchanged builders. The 1.0.0 evidence tables are
...
- `software/` — exact Python source and tests snapshot used for version 1.3.1.
