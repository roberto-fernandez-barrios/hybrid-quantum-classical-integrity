...
Fecha de corte: 8 de septiembre de 2026 (versión 1.3.4, corrección
bibliográfica/editorial y de metadata derivada; metodología sin cambios desde 1.3.2; evidencia
...
- Gate A: 240/240 jobs; réplica exacta de controles; stress test de un fingerprint frágil dependiente de clústeres. `AdvDetCtrlIXMin/Max`, `AdvDetCtrlHeadlineMin/Max` y `AdvDetAdaptiveHeadlineMin/Max` son la fuente única de los rangos por régimen y headline; no se interpreta como derrota de un detector generalmente potente. De 6.000 filas, 3.418 son materiales; P2 sirve 1.328 / 959 / 1.006 (tasas agregadas 0,39 / 0,28 / 0,29). En `I_XFY`, por intensidad 0,02/0,05/0,10, sirve 0,90/0,67/0,46 para mean shift y 0,55/0,36/0,22 para scaling; la tabla completa incluye 0,25/0,50, materialidad y detección en los tres regímenes.
...
**Paper 1.5 (cerrado metodológicamente en 1.3.2 y correctivamente en 1.3.4):** auditabilidad de integridad
