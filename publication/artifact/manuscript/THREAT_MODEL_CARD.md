...
| `I_XFY` (batch) | multiset of item triples; Class-A statistical aggregate comparison against the clean same-item-set benchmark oracle, without item pairing | none for material label changes (Proposition 3); aligned response is 343/2,700 conformal and 1,183/2,700 union, while original frozen response is 11/2,617 conformal and 43/2,617 union | conformal FPR 0.053; benchmark protection is not deployed authentication |
