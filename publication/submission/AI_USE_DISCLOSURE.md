# Generative-AI disclosure (artifact 1.3.3; authors retain full responsibility)
...
> regression guards, PDF verification and release preparation. The authors specified the protocols,
...
all authors (communicated by the corresponding author). The 1.3.3
bibliographic/editorial closure was performed under author instruction; the
