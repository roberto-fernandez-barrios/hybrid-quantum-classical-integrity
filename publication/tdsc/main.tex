...
% TDSC does not offer double-anonymous review. Author block and changes through 1.3.3 are author-approved.
...
commitment to the same batch certifies that the honest labels give the reported
...
and transparency \cite{TorresArias2019,SLSA2026,Newman2022}. Remote attestation
...
the executed design's premise violation. The earlier asymmetric variant had no
such guarantee (Proposition~5(c)).
...
earlier asymmetric rules (Proposition~5(c)). The earlier rule's pooled excess
...
draws per cell; the artifact records the protocol, amendment and preregistered
expectations. Because a run's 20 draws overlap within one pool half, false-alarm
...
detection only with a sufficiently tight null. The offline result makes the
consequence concrete: with typical batch-level evidence, a calibrated policy
serves about three fifths of this suite's materially changed results, and the
information regime sets that share. The adversarial gate adds that calibration
...
1.3.3 is archived at Zenodo, version DOI 10.5281/zenodo.22666931 (concept DOI
...
implementation audit and the 1.3.3 bibliographic/editorial correction. The authors specified
