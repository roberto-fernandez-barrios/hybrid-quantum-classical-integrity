...
OpenAI Codex and Anthropic Claude Code assisted with draft/language review,
code generation/inspection, literature-search support and artifact preparation
across the manuscript and supplement. Human authors independently checked all
claims, proofs, references, experiments, results and generated text using the
stated tests, verifiers and primary sources, and assume full responsibility.
Neither system is an author or proof authority; detailed disclosure accompanies
the submission.
